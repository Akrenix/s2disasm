...
REM // echo Assembling REV01...
REM // echo | call build -a -r1 > NUL
IF EXIST s2built.bin (
...
REM // echo Assembling REV02...
REM // echo | call build -a -r2 > NUL
IF EXIST s2built.bin (
